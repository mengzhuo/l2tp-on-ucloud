#!/bin/sh
#
# Ucloud UHost user-data file for automatic configuration of IPsec/L2TP VPN
...
# https://mengzhuo.org/blog/ipsec-l2tp-vpn-setup-for-ubuntu-14.04-on-ucloud-uhost.html
# Original post by Thomas Sarlandie Lin Song: 
...
read -p "IPSEC Private Secret Key:" IPSEC_PSK
...
# If using Ucloud UHost, these ports must be open in the security group of
# your VPN server: UDP ports 500 & 4500, and TCP port 22 (optional, for SSH).

# In Ucloud UHost, these two variables will be found automatically
